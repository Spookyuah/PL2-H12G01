...
public class GsonUtilEjemplo {
    ...
    public static void main(String[] args) {
        ...
        Usuario usuario = new Usuario("Stark", 19, "stark@example.com");
...
// Getters y setters no incluidos por brevedad
    ...
    public class MainLectura {
        public static void main(String[] args) {
            ...
            Usuario usuario = GsonUtilEjemplo.cargarObjetoDesdeArchivo(
                    rutaArchivo, Usuario.class);

            if (usuario != null) {
                System.out.println(usuario.nombre);
            }
        }
    }   //Cambia la salida del programa si se modifica el fichero
}
